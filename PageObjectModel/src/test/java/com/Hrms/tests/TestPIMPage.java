...
public class TestPIMPage extends BasePage{
		...
		WebDriver driver;
			...
			public void addEmployee() throws Exception {
			    ...
			    // Click on the "Add Employee" button
			    CommonUtils.clickElement(PIMPage.getAddEmp1());
			    
			    // Click on the "Add Employee" button
			    CommonUtils.clickElement(PIMPage.getAddEmp2());
			    
			    CommonUtils.searchEmployeePage(PIMPage.searchEmployee(), "java");
			...
			public void searchEmployers() throws Exception {
